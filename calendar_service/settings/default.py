...
# Django settings for calendar_service - suitable for production
...
SECRET_KEY = 'pvgk=axghf)@iy03x@b!8p*1)@_)$f1&0+2(9%f$(7z-2*8vx5'
...
ADMINS = (
    ('Daron Stinnett', 'adaron@offlinelabs.com'),
)
MANAGERS = ADMINS
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(ABS_PROJECT_ROOT, 'db.sqlite3'),
...
LOCAL_APPS = (
    'calendar_service.home',
    'calendar_service.schedule',
    'calendar_service.api',
)
