...
class TestTemplateTags(TestCase):
    ...
    def test_prev_url(self):
        ...
        url_params = escape('/schedule/calendar/month/MyCalSlug/?year={0}&month=2&day=6&hour=0&minute=0&second=0'.format(datetime.datetime.now().year))
    ...
    def test_next_url(self):
        ...
        url_params = escape('/schedule/calendar/month/MyCalSlug/?year={0}&month=2&day=8&hour=0&minute=0&second=0'.format(datetime.datetime.now().year))
    ...
    def test_create_event_url(self):
        ...
        expected = ('/schedule/event/create/MyCalSlug/?year={0}&month=1&day=4&hour=7&minute=0&second=0'.format(datetime.datetime.now().year))
